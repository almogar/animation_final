...
void SandBox::updateMovement() {
    ...
    if (left)
    {
        Joints[joints_num].MyTranslateInSystem(Joints[joints_num].MakeTransd(), Eigen::Vector3d(0.1, 0, 0), true);
    ...
    if (up)
    {
        Joints[joints_num].MyTranslateInSystem(Joints[joints_num].MakeTransd(), Eigen::Vector3d(0, 0.1, 0), true);
    ...
    if (in)
    {
        ...
        Joints[joints_num].MyTranslateInSystem(Joints[joints_num].MakeTransd(), Eigen::Vector3d(0, 0, 0.1), true);
